                ...
                <div class="card pd-1">
                    <div class="card-body">
                        <div class="Device">
                            ...
                            <h4 class="text-start f16 parkinsans-light"><b>Location:</b> <i>{{ $lokasi->lokasi ?? 'Unknown' }}</i></h4>
                            <h4 class="text-start f16 parkinsans-light"><b>OS:</b> <i>{{ $lokasi->os }}</i></h4>
                            <h4 class="text-start f16 parkinsans-light"><b>Browser:</b> <i>{{ getBrowser($lokasi->browser ?? '') }}</i></h4>
                            <h4 class="text-start f16 parkinsans-light"><b>IP Address:</b> <i>{{ $lokasi->ip_address ?? 'Unknown' }}</i></h4>
                        </div>
                    </div>
                </div>
            </div>
